...
png(filename = "./coursera_repo/exploratory_data_analysis/courseProject1/plot1.png")

with(tab, hist(Global_active_power, col = "red", breaks = 12, 
     xlab = "Global Active Power (kilowatts)", main = "Global Active Power", bg = "grey"))
