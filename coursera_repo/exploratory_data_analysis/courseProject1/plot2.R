...
png(filename = "./coursera_repo/exploratory_data_analysis/courseProject1/plot2.png")

with(tab, plot(Global_active_power, ylab = "Global Active Power (kilowatts)", type = "l", xaxt = "n"))
with(tab, axis(1, at = c(0, 1440, 2880), labels = c("Thu", "Fri", "Sat")))
dev.off()
